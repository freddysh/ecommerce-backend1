(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Store_Order_orders-entregar_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      currentPage: 1,
      per_page: 10
    }, _defineProperty(_ref, "valorBuscar", ""), _defineProperty(_ref, "paginate", ["itemss"]), _ref;
  },
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat("https://sistemaorion.nebulaperu.com", "/api/v1/orders"));

              case 2:
                datos = _context.sent;
                rpt = datos.data.map(function (item) {
                  return {
                    id: item.id,
                    code: item.code,
                ...
                console.log(rpt);
                _this.items = rpt; //   this.items = rpt.filter(event => event.entregado_user == Date();
  ...
  computed: {
    ...
    itemss: function itemss() {
      ...
      if (this.filtro == 1) {
        ...
        // });
        var fecha = this.moment().format("Y-MM-DD");
        console.log("La fecha:".concat(fecha));
        return this.items.filter(function (fila) {
          return _this2.moment(fila.encamino_user).format("Y-MM-DD") == fecha;
        });
      }

      if (this.filtro == 2) {
        var _fecha = this.moment().format("Y-MM-DD");

        var fecha7 = this.moment().add(-7, "days").format("Y-MM-DD");
        return this.items.filter(function (fila) {
          if (fecha7 <= _this2.moment(fila.encamino_user).format("Y-MM-DD") && _this2.moment(fila.encamino_user).format("Y-MM-DD") <= _fecha) {
            return fila;
          }
        });
      }
      ...
      if (this.filtro == 3) {
        var mes = this.moment().format("MM");
        var anio = this.moment().format("Y");
        var primera_fecha = this.moment().startOf("month").format("YYYY-MM-DD");
        var segunda_fecha = this.moment().endOf("month").format("YYYY-MM-DD");
        return this.items.filter(function (fila) {
          if (primera_fecha <= _this2.moment(fila.encamino_user).format("Y-MM-DD") && _this2.moment(fila.encamino_user).format("Y-MM-DD") <= segunda_fecha) {
            return fila;
          }
        });
      }
      ...
      if (this.filtro == 4) {
        if (this.rango_fecha.length > 0) {
          var _primera_fecha = this.moment(this.rango_fecha[0]).format("YYYY-MM-DD");

          var _segunda_fecha = this.moment(this.rango_fecha[1]).format("YYYY-MM-DD");

          return this.items.filter(function (fila) {
            if (_primera_fecha <= _this2.moment(fila.encamino_user).format("Y-MM-DD") && _this2.moment(fila.encamino_user).format("Y-MM-DD") <= _segunda_fecha) {
              return fila;
            }
          });
        }
      ...
      if (this.filtro == 5) {
        return this.items.filter(function (valor) {
          return valor.full_name.toLowerCase().includes(_this2.valorBuscar.toLowerCase());
        });
      } //   if (this.filtro == 1) {
      //     return this.items.filter(valor => {
      //       return valor.name
...
/***/ "./resources/js/components/Store/Order/orders-entregar.vue":
/*!*****************************************************************!*\
  !*** ./resources/js/components/Store/Order/orders-entregar.vue ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./orders-entregar.vue?vue&type=template&id=67c37778& */ "./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778&");
/* harmony import */ var _orders_entregar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./orders-entregar.vue?vue&type=script&lang=js& */ "./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _orders_entregar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__.render,
  _orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Store/Order/orders-entregar.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_entregar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./orders-entregar.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_entregar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778&":
/*!************************************************************************************************!*\
  !*** ./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_entregar_vue_vue_type_template_id_67c37778___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./orders-entregar.vue?vue&type=template&id=67c37778& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Store/Order/orders-entregar.vue?vue&type=template&id=67c37778& ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "p-2 card-body" }, [
          ...
          _c("div", { staticClass: "card" }, [
                ...
                _c("div", { staticClass: "col-4 d-none" }, [
                  _c("div", { staticClass: "form-group" }, [
                    _c(
                      ...
                      _vm._l(_vm.filtros, function(item, key) {
                        return _c(
                          "option",
                    ...
                    ? _c(
                        ...
                        [
                          _c("date-picker", {
                            attrs: { range: "" },
                            model: {
                              value: _vm.rango_fecha,
                              callback: function($$v) {
                                _vm.rango_fecha = $$v
                              },
                              expression: "rango_fecha"
                            }
                          })
                        ],
                        1
            ...
            _c("div", { staticClass: "p-2 card-body bg-gradient-secondary" }, [
              _vm.items && _vm.items.length > 0
                          ...
                          ? _c("div", { staticClass: "card" }, [
                              _c("div", { staticClass: "p-1 card-body" }, [
                                _c(
                                  ...
                                  {
                                    attrs: {
                                      href: "../orders/entregar/show/" + item.id
                                    }
                                  },
                                  [
                                    _c("div", { staticClass: "row" }, [
                ...
                : _c("span", [_vm._v("No se encontraron datos.")])
            ])
          ])
        ])
      ])
