...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: (_methods = {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat("http://sistemaorion.green.com.pe", "/api/v1/brands"));

              case 2:
                datos = _context.sent;
                _this.brands = datos.data.map(function (obj) {
                  return {
                    id: obj.id,
                    value: obj.name,
                    text: obj.name,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _this2.units = datos.data.map(function (obj) {
                  return {
                    id: obj.id,
                    value: obj.name,
                    text: obj.name,
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat("http://sistemaorion.green.com.pe", "/api/v1/categories"));

              case 2:
                datos = _context3.sent;
                _this3.categories = datos.data.map(function (obj) {
                  return obj.name;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat("http://sistemaorion.green.com.pe", "/api/v1/products"));

              case 2:
                datos = _context4.sent;
                rpt = datos.data.map(function (obj) {
                  return {
                    id: obj.id,
                    code: obj.code,
                    name: obj.name,
                    ...
                    stock: obj.stock,
                    limit: obj.limit,
                    rango_fecha: obj.valido_desde && obj.valido_hasta ? Array(new Date(obj.valido_desde), new Date(obj.valido_hasta)) : Array(new Date(), new Date()),
                    unit: obj.unit,
                    brand: obj.brand,
                    categorias: obj.categorias.map(function (categorias_) {
                      return categorias_.name;
                    }),
                    photos: obj.photos.map(function (phot) {
                      return {
                        id: phot.id,
                        imgSrc: phot.photo ? "/api/v1/products/imagen/".concat(phot.photo) : "",
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                console.log("agregar"); // if(this.post.titulo.trim().length==0)
                //     return;
                ...
                _this5.product.regular_price = _this5.precio;
                _this5.product.url = _this5.url;

                if (!(_this5.product.id > 0)) {
                  _context5.next = 11;
                  break;
                }

                _context5.next = 6;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().put("".concat("http://sistemaorion.green.com.pe", "/api/v1/products/").concat(_this5.product.id), _this5.product);
              ...
              case 6:
                ...
                if (datos.data.status == 1) {
                  ...
                  _this5.limpiarCampos(); // this.ocultar();
              ...
              case 11:
                _context5.next = 13;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post("".concat("http://sistemaorion.green.com.pe", "/api/v1/products"), _this5.product);

              case 13:
                _datos = _context5.sent;
                console.log("rpt;", _datos.data);

                if (_datos.data.status == 1) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().delete("".concat("http://sistemaorion.green.com.pe", "/api/v1/products/").concat(brand_id));
    ...
    borrar: function borrar(brand_id) {
      var _this8 = this;
      ...
      Vue.swal.fire({
        ...
        if (result.isConfirmed) {
          _this8["delete"](brand_id);
        }
      });
    },
    cambiar_estado: function cambiar_estado(brand_id, valor) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("".concat("http://sistemaorion.green.com.pe", "/api/v1/products/swith-state/").concat(brand_id, "/").concat(valor));

              case 3:
                datos = _context7.sent;
                console.log("rpt:", datos.data);

                if (datos.data.status == 1) {// alert('datos guardados')
                  // this.index();
                }
    ...
    handleSubmit: function handleSubmit() {
      ...
      this.agregar(); // Hide the modal manually

      this.$nextTick(function () {
        _this9.toggleModal();
      });
    },
    iniciarForm: function iniciarForm() {
      this.limpiarCampos();
      this.toggleModal();
    },
  ...
  }, _defineProperty(_methods, "toggleModal", function toggleModal() {
    // We pass the ID of the button that we want to return focus to
    // when the modal has hidden
    //   this.$refs["modal"].toggle("#toggle-btn");
    $("#exampleModal").modal("toggle");
  }), _defineProperty(_methods, "onOptionClick", function onOptionClick(_ref) {
    var option = _ref.option,
        addTag = _ref.addTag;
    addTag(option);
    this.search = "";
  }), _defineProperty(_methods, "borrar_imagen", function borrar_imagen(value) {
    var indice = this.product.photos.indexOf(value);
    if (indice != -1) this.product.photos.splice(indice, 1);
  }), _defineProperty(_methods, "onFileChanges", function onFileChanges(e) {
    // this.message = ''
    console.log("generamos la imagen");
    this.selectedFiles = e.target.files[0];
    this.createImages(this.selectedFiles);
  }), _defineProperty(_methods, "createImages", function createImages(file) {
    var _this10 = this;
  ...
  computed: {
    ...
    tituloModal: function tituloModal() {
    ...
    itemss: function itemss() {
      ...
      return this.items.filter(function (valor) {
        return valor.code.toLowerCase().includes(_this11.valorBuscar.toLowerCase());
      });
    },
    url: function url() {
      ...
      slug = slug.replace(/[`~!@#$%^&*()_\-+=\[\]{};:'"\\|\/,.<>?\s]/g, " ").toLowerCase(); // Reemplaza los carácteres especiales | simbolos con un espacio
      ...
      slug = slug.replace(/ñ|Ñ/g, "n").toLowerCase(); // Corta los espacios al inicio y al final del sluging

      slug = slug.replace(/^\s+|\s+$/gm, ""); // Reemplaza el espacio con guión
    ...
    precio: function precio() {
      var valor = 0;
      valor = parseFloat(this.product.price) + parseFloat(this.product.discount) * parseFloat(this.product.price) / 100;
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue2-datepicker/index.css":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue2-datepicker/index.css ***!
  \**********************************************************************************************************************************************************************************************************/
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=6d5f1c92& */ "./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  ...
  _index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92&":
/*!****************************************************************************************!*\
  !*** ./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92& ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6d5f1c92___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=6d5f1c92& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Admin/Product/index.vue?vue&type=template&id=6d5f1c92& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            "button",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.iniciarForm()
                }
              }
            },
            [
              _c("i", { staticClass: "las la-plus-circle" }),
              _vm._v(" Nuevo\n        ")
            ]
          )
        ])
                  ...
                  _c("form", { ref: "form" }, [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "col col-sm-12 col-md-2" }, [
                          _c("div", { staticClass: "form-group" }, [
                            ...
                            _c(
                              ...
                              _vm._l(_vm.brands, function(brand_, key) {
                                return _c(
                                  "option",
                                  {
                                    key: key,
                                    domProps: { value: brand_.value }
                                  },
                                  [_vm._v(_vm._s(brand_.text))]
                                )
                              }),
                              0
                            )
                        ...
                        _c("div", { staticClass: "col col-sm-12 col-md-2" }, [
                          _c("div", { staticClass: "form-group" }, [
                            ...
                            _c(
                              ...
                              _vm._l(_vm.units, function(unit_, key) {
                                return _c(
                                  "option",
                                  {
                                    key: key,
                                    domProps: { value: unit_.value }
                                  },
                                  [_vm._v(_vm._s(unit_.text))]
                                )
                              }),
                              0
                            )
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "col col-sm-12 col-md-8" }, [
                          _c(
                            "div",
                            [
                              ...
                              _c("multiselect", {
                                ...
                                model: {
                                  value: _vm.product.categorias,
                                  callback: function($$v) {
                                    _vm.$set(_vm.product, "categorias", $$v)
                                  },
                                  expression: "product.categorias"
                                }
                              })
                            ],
                            1
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "col col-sm-12 col-md-3" }, [
                          _c(
                            "div",
                            { staticClass: "form-group" },
                            [
                              _c("label", { attrs: { for: "my-checkbox" } }, [
                                _vm._v("El producto tiene limite de stock?")
                              ]),
                              _vm._v(" "),
                              _c("vs-switch", {
                                model: {
                                  value: _vm.product.limit,
                                  callback: function($$v) {
                                    _vm.$set(_vm.product, "limit", $$v)
                                  },
                                  expression: "product.limit"
                                }
                              })
                            ],
                            1
                        ...
                        _vm.product.limit
                          ? _c(
                              "div",
                              { staticClass: "col col-sm-12 col-md-3" },
                              [
                                _c("div", { staticClass: "form-group" }, [
                                  _c("label", { attrs: { for: "url" } }, [
                                    _vm._v("Stock")
                        ...
                        _vm.product.limit
                          ? _c(
                              "div",
                              { staticClass: "col col-sm-12 col-md-6" },
                              [
                                _c(
                                  "div",
                                  { staticClass: "form-group" },
                                  [
                                    ...
                                    _c("date-picker", {
                                      ...
                                      model: {
                                        ...
                                        expression: "product.rango_fecha"
                                      }
                                    })
                                  ],
                                  1
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.product.photos, function(imagen, key) {
                          return _c(
                            "div",
                            { key: key, staticClass: "col col-sm-12 col-md-3" },
                            [
                              _c("div", { staticClass: "card" }, [
                                _c("div", { staticClass: "card-body" }, [
                                  _c("div", { staticClass: "row" }, [
                                    _c("div", { staticClass: "col-md-12" }, [
                                      _vm._v("Imagen " + _vm._s(key + 1))
                                    ]),
                                    _vm._v(" "),
                                    _c("div", { staticClass: "col-md-12" }, [
                                      _c("img", {
                                        staticClass: "output w-50",
                                        attrs: { src: imagen.imgSrc }
                                      })
                                    ]),
                                    _vm._v(" "),
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c(
                                            "label",
                                            {
                                              attrs: { for: "principal" + key }
                                            },
                                            [_vm._v("Convertir en principal")]
                                          ),
                                          _vm._v(" "),
                                          _c("vs-switch", {
                                            model: {
                                              value: imagen.state,
                                              callback: function($$v) {
                                                _vm.$set(imagen, "state", $$v)
                                              },
                                              expression: "imagen.state"
                                            }
                                          })
                                        ],
                                        1
                                    ...
                                    _c("div", { staticClass: "col-md-6" }, [
                                      _c(
                                        "button",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.borrar_imagen(imagen)
                                            }
                                          }
                                        },
                                        [
