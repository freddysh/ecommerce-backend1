...
//            'label_color' => 'success',
        ...
        [
            ...
            'icon'        => 'fa fa-cog',
            'can'       => 'Listar Ordenes',
            'active'        => ['admin/orders/list/*'],
//            'label'       => 4,
//            'label_color' => 'success',
        ],[
            'text'        => 'Ordenes para empacar',
            'route'         => 'admin.orders_empacar',
            'icon'        => 'fa fa-cog',
            'can'       => 'Listar Ordenes Para Empacar',
            'active'        => ['admin/orders_empacar/*'],
//            'label'       => 4,
//            'label_color' => 'success',
        ],[
            ...
            'icon'        => 'fa fa-cog',
            'can'       => 'Listar Ordenes Para Entregar',
...
//            'label_color' => 'success',
        ...
        [
            ...
            'route'         => 'admin.orders_entregadas',
            'icon'        => 'fa fa-cog',
            'can'       => 'Listar Ordenes Entregadas',
